...
FROM rust:1.94-slim@sha256:da9dab7a6b8dd428e71718402e97207bb3e54167d37b5708616050b1e8f60ed6 AS chef
...
COPY . .
# apps/tauri is a desktop-only GUI; excluded from Docker via .dockerignore
